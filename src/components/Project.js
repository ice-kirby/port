    ...
    <div className="Project">
      <div className="Pline1">
        ...
        <div className="ProWord">
          ...
          <br />
          <br />
          개발사항 : 날씨 API를 사용해 현재 기온을 불러왔다. 고른 옷의 점수를
          계산하여 로컬스토리지에 저장 후 날씨 점수를 산정해 둘을 비교하게
          만들었다.
        </div>
      </div>
      ...
      <div className="Pline2">
        ...
        <div className="ProWord">
          <span>
            아이스크림 트럭 컨셉으로 제작한 Todo-app. 민트초코 칸은 현재의 할
            일, 블루레몬에이드 칸은 완료된 칸이다.
          </span>
          <br />
          <br />
          사용기술 : HTML, CSS, JAVASCRIPT, REACT
          <br />
          <br />
          개발사항 : map을 이용해 할 일 목록의 완료 처리와 삭제 버튼을
          작동시켰다. 완료 목록의 filter로 목록을 월 별로 확인할 수 있다.
        </div>
      </div>
      ...
      <div className="Pline3">
        ...
        <div className="ProWord">
          ...
          <br />
          <br />
          사용기술 : HTML, SCSS, JAVASCRIPT, REACT
          <br />
          <br />
          개발사항 : router를 이용해 일기 입력칸과 일기 목록을 분리했다. css
          애니메이션으로 "캐릭캐릭체인지"의 마스코트들이 움직이도록 만들었다.
        </div>
      </div>
      ...
      <div className="Pline4">
        ...
        <div className="ProWord">
          ...
          <br />
          <br />
          개발사항 : 기존 자바스크립트로 짜여진 사이트를 React - router로
          개편하고 있다. key-color 수정 및 추가하고, 사이트 내 애니메이션을
          추가할 예정이다.
        </div>
      </div>
    </div>
